...
public class RectangleStrategy implements ShapeStrategy {
   ...
   * This is a runner method. This method will create a Rectangle object based on ShapeProperties object passed to it and initialize it into its private Shape shape variable.
   */
  @Override
  public void drawStrategy(Graphics2D graphics, ShapeProperties properties){
    shape = new Rectangle2D.Double(properties.x, properties.y, properties.length, properties.height);
  }
